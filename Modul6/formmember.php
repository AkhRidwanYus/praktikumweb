...
<body>
    ...
    <form name="tambahmember" action="" method="POST">
        ...
        <input type="password" name="pass" <?php echo (isset($_GET['id_member'])) ?  "value = " . $result[0]["pass"] . "" : "value = '' "; ?> required><br/><br/>
        <?php
	...
	<?php
		if(isset($_POST['addmember']) && ($_POST['nama']) && ($_POST['no']) && ($_POST['alamat']) && ($_POST['tgldft']) && ($_POST['tgltrkhrbyr']) && ($_POST['pass'])){
			tambahmember($_POST['nama'], $_POST['no'], $_POST['alamat'], $_POST['tgldft'], $_POST['tgltrkhrbyr'], $_POST['pass']);
		}
		if(isset($_POST['updatemember']) && ($_POST['nama']) && ($_POST['no']) && ($_POST['alamat']) && ($_POST['tgldft']) && ($_POST['tgltrkhrbyr']) && ($_POST['pass'])){
			updatemember($id , $_POST['nama'], $_POST['no'], $_POST['alamat'], $_POST['tgldft'], $_POST['tgltrkhrbyr'], $_POST['pass']);
		}
	?>
</body>